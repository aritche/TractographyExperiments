...
w_seeds = 1 # weight for the seed loss
...
class CustomModel(nn.Module):
    def __init__(self):
        ...
        self.down_conv_1 = nn.Conv3d(in_channels=4, out_channels=32, kernel_size=(9,9,9), stride=1, padding=0)     # K   x 136 x 136 x 136 ->        3*(3*9^3+1)     = 6.5K
...
def CustomLoss(output, target):
    ...
    return w_coords*position_loss + w_seeds*seed_loss
